      ...
      class ProjectMetadataCache
        ...
        def update_metadata!(pod_target_installation_results, aggregate_target_installation_results)
          ...
          installation_results.each do |installation_result|
            ...
            # server targets need to be added to the cache because they can be used as server hosts for test targets, even if those test targets live inside a different pod (and thus project)
